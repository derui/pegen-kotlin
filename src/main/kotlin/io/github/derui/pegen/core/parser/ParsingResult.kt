...
sealed class ParsingResult<T> private constructor() {
    companion object {
         ...
         */
        fun <R> rawOf(value: String): ParsingResult<R> = Raw(value)

        /**
         * Create a [Constructed] instance.
         */
        fun <R> constructedAs(value: R): ParsingResult<R> = Constructed(value)
     ...
     */
    class Raw<T> internal constructor(val value: String) : ParsingResult<T>() {
     ...
     */
    class Constructed<T> internal constructor(val value: T) : ParsingResult<T>() {
